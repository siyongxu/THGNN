...
author_select = pd.read_csv('data/DBLP/DBLP_author_2008.txt', sep='\t', header=None, names=['author_id', 'author_name'], keep_default_na=False, encoding='utf-8')
paper_author = pd.read_csv('data/DBLP/DBLP_paper_author.txt', sep='\t', header=None, names=['paper_id', 'author_id'], keep_default_na=False, encoding='utf-8')
paper_conf = pd.read_csv('data/DBLP/DBLP_paper_conf.txt', sep='\t', header=None, names=['paper_id', 'conf_id'], keep_default_na=False, encoding='utf-8')
paper_term = pd.read_csv('data/DBLP/DBLP_paper_term.txt', sep='\t', header=None, names=['paper_id', 'term_id'], keep_default_na=False, encoding='utf-8')
paper_year = pd.read_csv('data/DBLP/DBLP_paper_year.txt', sep='\t', header=None, names=['paper_id', 'year'], keep_default_na=False, encoding='utf-8')
papers = pd.read_csv('data/DBLP/DBLP_paper.txt', sep='\t', header=None, names=['paper_id', 'paper_title','paper_abstract'], keep_default_na=False, encoding='utf-8')
terms = pd.read_csv('data/DBLP/DBLP_term.txt', sep='\t', header=None, names=['term_id', 'term'], keep_default_na=False, encoding='utf-8')
confs = pd.read_csv('data/DBLP/DBLP_conf.txt', sep='\t', header=None, names=['conf_id', 'conf'], keep_default_na=False, encoding='utf-8')
